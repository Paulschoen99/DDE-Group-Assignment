...
def value_optimizer():
    ...
    image_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/WHU_Logo.svg/1200px-WHU_Logo.svg.png"
...
def chatbot_page():
    st.title('Welcome to the BASF Security Chatbot! - A Chatbot powered by OpenAI')
    ...
    if st.button('Ask'):
        ...
        assistant_id = "asst_bA9jewI6zgLvtQAH6MqGT5Ms"  
